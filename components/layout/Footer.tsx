        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-xs">
              Professional design and printing services. Quality prints delivered to your doorstep across Nigeria.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li className="flex items-start gap-2">
                ...
                Block A2-12 Suite 326, Sura Shopping Complex, Lagos
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <Container className="py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/50">
            © {new Date().getFullYear()} PrintHere. All rights reserved.
          </p>
